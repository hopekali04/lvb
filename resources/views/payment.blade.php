    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="accordion" id="accordionPayment">
          ...
          <div class="accordion-item mb-3 border">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapseAM" aria-expanded="false">
                <input class="form-check-input" type="radio" name="payment" id="payment3">
                <label class="form-check-label pt-1" for="payment3">
                  Airtel Money
                </label>
              </div>
                <img src="image/Airtel_Uganda-Logo.wine.png" width="100" height="50"/>
            </h2>
            <div id="collapseAM" class="accordion-collapse collapse" data-bs-parent="#accordionPayment" style="">
              <div class="accordion-body">
                <div class="px-2 col-lg-6 mb-3">
                  <label class="form-label">Email address</label>
                  <input type="email" class="form-control">
          ...
          <div class="accordion-item mb-3 border">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTM" aria-expanded="false">
                <input class="form-check-input" type="radio" name="payment" id="payment4">
                <label class="form-check-label pt-1" for="payment4">
                  TNM Mpamba
                </label>
              </div>
                <img src="image/mpamba.png" width="100" height="40"/>
              </span>
            </h2>
            <div id="collapseTM" class="accordion-collapse collapse" data-bs-parent="#accordionPayment" style="">
              <div class="accordion-body">
                <div class="px-2 col-lg-6 mb-3">
                  <label class="form-label">Email address</label>
                  <input type="email" class="form-control">
